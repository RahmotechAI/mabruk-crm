...
const TYPES: { value: StockMovementType; label: string; color: string }[] = [
  { value: 'incoming', label: 'Поступление', color: 'text-emerald-700' },
  { value: 'return', label: 'Возврат', color: 'text-amber-700' },
  { value: 'loss', label: 'Списание', color: 'text-red-700' },
]
...
export function StockMovementForm({ products, locationId }: Props) {
